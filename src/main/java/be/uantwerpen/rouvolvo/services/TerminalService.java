package be.uantwerpen.rouvolvo.services;

import be.uantwerpen.rouvolvo.tools.Terminal;
...
public class TerminalService
{
    ...
    {
        terminal.printTerminal("\nRouVolvo [Version " + getClass().getPackage().getImplementationVersion() + "]\n(c) 2017 University of Antwerp. All rights reserved.");
